...
| ------- | ------------------ | ----------------- | ------------ | ----- |
| 1.10.x  | :white_check_mark: | 1.18 - 26.1.x     | 17+          | Current stable release |
| 1.9.x   | :white_check_mark: | 1.18 - 26.1.x     | 17+          | Security fixes only |
| 1.8.x   | :x:                | 1.18 - 26.1.x     | 17+          | No longer supported |
